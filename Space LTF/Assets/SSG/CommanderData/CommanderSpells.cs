...
public class CommanderSpells
{
    ...
    public void AddPriorityTarget()
    {
        ...
        var spellInGame = new SpellInGame(priority,()=> mainShip.Position, mainShip.TeamIndex, mainShip, 1,
            Namings.PriorityTarget, Library.PriorityTargetCostTime, Library.PriorityTargetCostCount, SpellType.priorityTarget,9999,Namings.PriorityTargetDesc);
        ...
        var baieSpell = new SpellInGame(priorityBait, () => mainShip.Position, mainShip.TeamIndex, mainShip, 1,
            Namings.BaitPriorityTarget, Library.BaitPriorityTargetCostTime, Library.BaitPriorityTargetCostCount, SpellType.BaitPriorityTarget,9999, Namings.BaitPriorityTargetDesc);
    ...
    public void AddSpell(BaseSpellModulInv baseSpellModul, Transform modulPos)
    {
        ...
        var spellInGame= new SpellInGame(baseSpellModul, () => modulPos.position,mainShip.TeamIndex,mainShip,1,
            baseSpellModul.Name, baseSpellModul.CostTime, baseSpellModul.CostCount,baseSpellModul.SpellType, baseSpellModul.BulleStartParameters.distanceShoot,baseSpellModul.Desc());
        AllSpells.Add(spellInGame);
    }
}
