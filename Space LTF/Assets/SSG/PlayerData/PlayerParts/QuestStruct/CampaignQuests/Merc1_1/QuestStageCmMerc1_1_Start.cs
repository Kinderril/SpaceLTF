...
[System.Serializable]
public class QuestStageCmMerc1_1_Start : QuestStage
{

    private FreeActionGlobalMapCell cell1 = null;

    public QuestStageCmMerc1_1_Start()    
        :base(QuestsLib.CM_MERC_1_1_START)
    {
    ...
    {
        _playerQuest.QuestIdComplete(QuestsLib.CM_MERC_1_1_START);
    ...
    private List<string> GetDialogsTag()
    {
        ...
        list.Add("cmMerc1_1_dialog_0_M1");
        list.Add("DC"); 
        return list;
    }
