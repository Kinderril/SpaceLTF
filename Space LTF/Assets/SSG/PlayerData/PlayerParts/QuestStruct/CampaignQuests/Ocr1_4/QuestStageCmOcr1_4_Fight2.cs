...
[System.Serializable]
public class QuestStageCmOcr1_4_Fight2 : QuestStage
{

    private FreeActionGlobalMapCell cell1 = null;
    public QuestStageCmOcr1_4_Fight2()    
        :base(QuestsLib.QuestStageCmOcr1_4_Fight2)
    {
    }
...
//        return mesData;
    ...
    {
        _playerQuest.QuestIdComplete(QuestsLib.QuestStageCmOcr1_4_Fight2);
        Fight();
    }
    ...
    private List<string> GetDialogsTag()
    {
        ...
        list.Add("cmOcr1_4_dialog_4_M1");
        list.Add("cmOcr1_4_dialog_4_A1");   
        list.Add("cmOcr1_4_dialog_4_M2");
        list.Add("cmOcr1_4_dialog_4_A2");   
        list.Add("cmOcr1_4_dialog_4_M3");
        list.Add("cmOcr1_4_dialog_4_A3");   
        list.Add("cmOcr1_4_dialog_4_M4");
        list.Add("cmOcr1_4_dialog_4_A4");
