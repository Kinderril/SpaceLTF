...
[System.Serializable]
public class QuestStageCmOcr1_2_Fight : QuestStage
{

    private FreeActionGlobalMapCell cell1 = null;
    public QuestStageCmOcr1_2_Fight()    
        :base(QuestsLib.QuestStageCmOcr1_2_Fight)
    {
    }
    ...
    {
        _playerQuest.QuestIdComplete(QuestsLib.QuestStageCmOcr1_2_Fight);
        Fight();
    }
