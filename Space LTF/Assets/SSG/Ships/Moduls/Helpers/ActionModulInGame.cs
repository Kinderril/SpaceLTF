...
public abstract class ActionModulInGame
{
    ...
    public static ActionModulInGame Create(BaseModulInv baseModulInv)
    {
...
//                return new CloseStrikeModul(baseModulInv);
    ...
    public ActionModulInGame(BaseModulInv baseModulInv)
    {
