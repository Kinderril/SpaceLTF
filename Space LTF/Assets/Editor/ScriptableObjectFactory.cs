...
{
	[MenuItem("Project/CreateWeapon/ScriptableObject")]
	[MenuItem("Assets/CreateWeapon/ScriptableObject")]
	public static void Create()
	{
		...
		var window = EditorWindow.GetWindow<ScriptableObjectWindow>(true, "CreateWeapon a new ScriptableObject", true);
		window.ShowPopup();
