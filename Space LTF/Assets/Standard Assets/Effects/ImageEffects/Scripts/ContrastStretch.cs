...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ContrastStretch : MonoBehaviour
    {
        ...
        private static readonly int _adaptTex = Shader.PropertyToID("_AdaptTex");
        private static readonly int _curTex = Shader.PropertyToID("_CurTex");
        private static readonly int _adaptParams = Shader.PropertyToID("_AdaptParams");
        ...
        void OnEnable()
        {
            for( int i = 0; i < 2; ++i )
            {
                if ( !adaptRenderTex[i] ) {
                    ...
                    adaptRenderTex[i].name = "AdaptRenderTex Contrast Stretch";
