...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class Bloom : PostEffectsBase
    {
        ...
        public void OnRenderImage (RenderTexture source, RenderTexture destination)
        {
            ...
            quarterRezColor.name = "Bloom QuarterRezColor";
            RenderTexture halfRezColorDown = RenderTexture.GetTemporary (rtW2, rtH2, 0, rtFormat);
            halfRezColorDown.name = "Bloom HalfRezColorDown";
            ...
            secondQuarterRezColor.name = "Bloom SecondQuarterRezColor";
            ...
            if (lensflareIntensity > Mathf.Epsilon)
			{
			    ...
			    rtFlares4.name = "Bloom RTFlares4";
            ...
            if (quality > BloomQuality.Cheap)
			{
			    ...
			    halfRezColorUp.name = "Bloom HalfRezColorUp";
