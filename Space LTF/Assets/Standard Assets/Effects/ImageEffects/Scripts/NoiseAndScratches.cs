...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class NoiseAndScratches : MonoBehaviour
    {
        ...
        private static readonly int _scratchTex = Shader.PropertyToID("_ScratchTex");
        private static readonly int _grainOffsetScale = Shader.PropertyToID("_GrainOffsetScale");
        private static readonly int _scratchOffsetScale = Shader.PropertyToID("_ScratchOffsetScale");
