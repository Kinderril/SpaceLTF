...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class SunShafts : PostEffectsBase
    {
        ...
        private static readonly int _blurRadius4 = Shader.PropertyToID("_BlurRadius4");
        private static readonly int _sunPosition = Shader.PropertyToID("_SunPosition");
        private static readonly int _sunThreshold = Shader.PropertyToID("_SunThreshold");
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            if (sunTransform)
                v = GetComponent<Camera>().WorldToViewportPoint(transform.position - sunTransform.forward);
            else
                v = GetComponent<Camera>().WorldToViewportPoint(transform.position + SunDirection);
            ...
            {
                /*
                var format= GetComponent<Camera>().hdr ? RenderTextureFormat.ARGBHalf: RenderTextureFormat.ARGB32;
