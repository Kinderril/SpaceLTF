...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class DepthOfField : PostEffectsBase {
        ...
        private static readonly int _fgOverlap = Shader.PropertyToID("_FgOverlap");
        private static readonly int _offsets = Shader.PropertyToID("_Offsets");
        private static readonly int _curveParams = Shader.PropertyToID("_CurveParams");
        private static readonly int _blurredColor = Shader.PropertyToID("_BlurredColor");
        private static readonly int _spawnHeuristic = Shader.PropertyToID("_SpawnHeuristic");
        private static readonly int _bokehParams = Shader.PropertyToID("_BokehParams");
        private static readonly int _fgCocMask = Shader.PropertyToID("_FgCocMask");
        private static readonly int _pointBuffer = Shader.PropertyToID("pointBuffer");
        private static readonly int _mainTex = Shader.PropertyToID("_MainTex");
        private static readonly int _screen = Shader.PropertyToID("_Screen");
        private static readonly int _lowRez = Shader.PropertyToID("_LowRez");
        #endregion
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination) {
            ...
            else if ((blurType == BlurType.DX11) && dx11bokehMaterial)
            {
                ...
                if (highResolution) {
                    ...
                    dx11bokehMaterial.SetBuffer (_pointBuffer, cbPoints);
