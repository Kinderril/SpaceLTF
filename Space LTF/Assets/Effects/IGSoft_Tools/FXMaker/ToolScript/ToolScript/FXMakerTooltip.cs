...
// 			case "BACKGROUND_HOVER"		: tooltip = arg + "\n" + helpStr[GetLang(), 3]		+ AddHintRect(FXMakerBackground.GetRect_Resources); break;
	...
	public static GUIContent GetHcToolBackground(string caption, string arg)
	{
		...
		string[,]	helpStr = {
								{
									 "- CreateWeapon new background information."
									,"- Delete [" + arg + "] the selected items."
									,"- CreateWeapon [" + arg + "] the clones of the selected items"
		...
		switch (caption)
		{
			...
			case "CreateWeapon Thumb": 		tooltip	= arg + "\n" + helpStr[GetLang(), 3];	break;
	...
	protected static string[,]	HcToolEffect = {
								{
									 "- CreateWeapon an empty 'Effect Prefab' in the current folder."
									,"- Delete the chosen 'Effect Prefab'." + "\n" +
									 ...
									 "- Current status = "
									,"- CreateWeapon a Clone of the chosen 'Effect Prefab'."
	...
	protected static string[,]	HcEffectControls = {
								{
									...
									,"- CreateWeapon the same Effect in order on 0.2-second basis in Trans simulation (successive shooting test)" + "\n" +
...
//		CheckValid(helpStr);
	...
	protected static string[,]	HcPopup_Sprite = {
								{
									...
									,"- PreFab : EffectPreFab + Material + SpriteTexture" + "\n" +
									 "- Texture : CreateWeapon only SpriteTexture. (CreatePath : [Resources]/[Sprite])"
	...
	public static GUIContent GetHcPopup_Sprite(string caption)
	{
		...
		switch (caption)
		{
			...
			case "CreateWeapon":				tooltip = HcPopup_Sprite[GetLang(),11]; break;
	...
	protected static string[,]	HsEditor_NcAutoDeactive = {
								{
									...
									,"- CreateWeapon additional Deactive condition besides Deactive method." + "\n" +
	...
	protected static string[,]	HsEditor_NcAutoDestruct = {
								{
									...
									,"- CreateWeapon additional destruction condition besides destruction method." + "\n" +
...
*/
	...
	protected static string[,]	HsEditor_NcDuplicator = {
								{
									"- CreateWeapon gameObject repeatedly at certain intervals." + "\n" +
