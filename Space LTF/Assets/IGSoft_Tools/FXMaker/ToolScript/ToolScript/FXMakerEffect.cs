...
// 		Debug.Log(defaultEffectPath);
	...
	// groupїН prefab path·О group №Ч Effect prefab indexё¦ БцБ¤ЗСґЩ.
	...
	// EffectFolderі»АЗ prefabЖДАП ±ёјєЗП±в, selectPrefabPathё¦ БцБ¤ЗТ °жїм EffectIndex ё®ЕП
